...
internal class TopRatedMoviesService: ITopRatedMoviesService {
    ...
    override fun getNextPage(refreshed: Boolean): Executioner<ArrayList<IMovie>> {
        ...
        executioner.setServiceExecutioner {
            ...
            MovieServices.retrofit.getTopRatedMovies(currentPage).enqueue(object: Callback<MoviesResponseDTO> {
